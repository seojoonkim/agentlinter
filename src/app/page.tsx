      ...
      <section id="changelog" className="py-16 px-5 sm:px-8 border-t border-[var(--border)]">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="space-y-8">
            {[
              { version: "v2.2.0", date: "2026-03-09", badge: "Latest", items: ["🪙 Token Budget+ — per-section token weight analysis with compression suggestions", "🛡️ Prompt Injection Defense — SECURITY.md presence check + injection phrase detection", "🧠 Cognitive Blueprint — 6-element agent coverage check (identity/goals/constraints/memory/planning/validation)", "📤 Multi-Framework Export — agentlinter export --format cursor/copilot/gemini", "🇰🇷 Korean Workspace Support — expanded escape hatch patterns + false positive fixes"] },
