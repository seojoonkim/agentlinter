      ...
      <section id="changelog" className="py-16 px-5 sm:px-8 border-t border-[var(--border)]">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="space-y-8">
            {[
              { version: "v2.3.0", date: "2026-03-14", badge: "Latest", items: ["🌱 Freshness Check — detects stale file path references & undocumented npm scripts (command-coverage)", "📁 compound/ exclusion — working docs no longer pollute Freshness/Consistency scores", "🎯 Consistency tuning — MEMORY.md historical log excluded from stale-reference checks", "🔍 Clarity tuning — Korean workspace false positives reduced, long-form memory files exempt", "🐛 False positive fixes — botToken keyword, r.ok code patterns, common-word acronyms"] },
              { version: "v2.2.0", date: "2026-03-09", badge: "", items: ["🪙 Token Budget+ — per-section token weight analysis with compression suggestions", "🛡️ Prompt Injection Defense — SECURITY.md presence check + injection phrase detection", "🧠 Cognitive Blueprint — 6-element agent coverage check (identity/goals/constraints/memory/planning/validation)", "📤 Multi-Framework Export — agentlinter export --format cursor/copilot/gemini", "🇰🇷 Korean Workspace Support — expanded escape hatch patterns + false positive fixes"] },
              ...
              { version: "v1.1.0", date: "2026-03-01", badge: "", items: ["🎯 Position Risk Warning — detects critical rules buried in the middle of files", "📊 Token Efficiency Score — grades files by line count (A/B/C/D)", "🔐 Enhanced Security — prompt injection + API key exposure detection"] },
